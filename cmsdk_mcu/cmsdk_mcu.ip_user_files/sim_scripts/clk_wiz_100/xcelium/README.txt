...
#
# Generated by export_simulation on Sun Jun 28 12:09:54 +0700 2020
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_100.sh' script.

./clk_wiz_100.sh -reset_run
...
./clk_wiz_100.sh -noclean_files

For more information on the script, please type './clk_wiz_100.sh -help'.
