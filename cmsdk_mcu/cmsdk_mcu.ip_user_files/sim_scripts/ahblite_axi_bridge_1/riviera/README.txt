...
#
# Generated by export_simulation on Sun Jun 28 11:49:20 +0700 2020
#
################################################################################
...
'-reset_run' switch to the './ahblite_axi_bridge_1.sh' script.

./ahblite_axi_bridge_1.sh -reset_run
...
./ahblite_axi_bridge_1.sh -noclean_files

For more information on the script, please type './ahblite_axi_bridge_1.sh -help'.
