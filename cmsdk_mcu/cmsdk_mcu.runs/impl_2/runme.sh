...
HD_PWD='C:/Users/Home/Desktop/cmsdk_mcu/cmsdk_mcu.runs/impl_2'
cd "$HD_PWD"
...
EAStep vivado -log cmsdk_mcu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cmsdk_mcu.tcl -notrace
