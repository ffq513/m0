...
HD_PWD='C:/Users/Home/Desktop/cmsdk_mcu/cmsdk_mcu.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cmsdk_mcu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cmsdk_mcu.tcl
